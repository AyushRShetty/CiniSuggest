...
const GenreQuickAccess = ({ onGenreSelect }) => {
  return (
    <div className="py-8">
      ...
      >
        {genres.map((genre) => (
          <motion.button
            key={genre.name}
            className={`flex items-center justify-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r ${genre.color} text-white font-medium shadow-md hover:shadow-lg transform transition-all duration-200 hover:-translate-y-1`}
